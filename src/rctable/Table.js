...
import addEventListener from './../common/addEventListener';
...
class RayTable extends Component {
  ...
  getHeader = (columns, fixed) => {
    ...
    if (expandIconAsCell && fixed !== 'right') {
      rows[0].unshift({
        key: 'ray-table-expandIconAsCell',
  ...
  syncFixedTableRowHeight = () => {
    ...
    if (simpleEqual(this.state.fixedColumnsHeadRowsHeight, fixedColumnsHeadRowsHeight) &&
        simpleEqual(this.state.fixedColumnsBodyRowsHeight, fixedColumnsBodyRowsHeight)) {
      return;
    }
    this.setState({
      fixedColumnsHeadRowsHeight,
